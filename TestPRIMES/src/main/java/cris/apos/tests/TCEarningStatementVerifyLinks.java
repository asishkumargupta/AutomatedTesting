...
import cris.apos.input.SingleLinkDetails;
...
public class TCEarningStatementVerifyLinks {

	@Test

	public void test_TCDailyReportsVerifyLinks () {
		WebDriver driver;
		Path inpFile = Paths.get(DiffUtilityFunctions.getPropertyValue("primesEarningStmtInputFile"));
	//	SoftAssert softAssert = new SoftAssert();
		...
		//driver.findElement(By.xpath("//*[@id='liStandardReports']/a/span[1]/b")).click();//Click Existing reports
		driver.findElement(By.xpath("//*[@id='LiearningStatement']/a/span/b")).click();//Click Earning Statement
		BrowserFunctions.waitForLoad(driver);
		//System.out.println("Waiting started at time  :" + cal.getTime());
	
		linkElement = BrowserFunctions.explicitWait(driver , "//*[@id='bookingLocation']"); //Wait for visibility of PASSENGER EARNING REPORT TAB under Earning Statement
		linkElement.click();//Click Daily reports
		...
		String functionName = "bookingLocation" ;
...
*/
		...
		for ( i = 0; i < completeLinkToVerify.size(); i++) {
			...
			try {
				...
				linkElement = BrowserFunctions.explicitWait(driver , "//*[@id='bookingLocation']");
				//*[@id="origpsgnErngBkgLoc"]
				linkElement.click();
				xpathFunctionName = "//*[@id='" + completeLinkToVerify.get(i).getfunctionName() + "\']" ;
				
				//For manipulating xpath for OVERSEAS TRAIN REPORT - start
				if (completeLinkToVerify.get(i).getfunctionName().equals("overseas")) {
					xpathFunctionName =	"(//SPAN[@id='others']/../../../../../..//SPAN[@id='others'])[2]";
		...
		//		driver.findElement(By.xpath("//*[@id='bookingLocation']")).click();
				
				//System.out.println("clicking xpath="+xpathFunctionName);
				
				driver.findElement(By.xpath(xpathFunctionName)).click();		
				
				
				
				driver.findElement(By.linkText(completeLinkToVerify.get(i).getLinkName())).click();

				//System.out.println(completeLinkToVerify.get(i).getLinkName() + " is working");

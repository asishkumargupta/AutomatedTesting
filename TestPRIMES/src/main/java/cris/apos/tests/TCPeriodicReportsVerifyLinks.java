...
public class TCPeriodicReportsVerifyLinks {

	@Test

	public void test_TCDailyReportsVerifyLinks () {
		WebDriver driver;
		Path inpFile = Paths.get(DiffUtilityFunctions.getPropertyValue("primesPeriodicRepInputFile"));
	//	SoftAssert softAssert = new SoftAssert();
		...
		linkElement = BrowserFunctions.explicitWait(driver , "//*[@id='liPeriodicReports']/a/span/b"); //Wait for visibility of Daily reports
...
*/
		...
		for ( i = 0; i < completeLinkToVerify.size(); i++) {
			...
			try {
				linkElement = BrowserFunctions.explicitWait(driver , "//*[@id='liPeriodicReports']/a/span/b");
